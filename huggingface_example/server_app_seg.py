...
import os, psutil
from huggingface_example.workflow_with_log import SecAggPlusWorkflowWithLogs
...
def main(grid: Grid, context: Context) -> None:
    ...
    #             strategy=strategy,
    #             )
    # workflow.attach_to_context(context)
    # # Execute
...
#     return ServerAppComponents(config=config, strategy=strategy, workflow=workflow)
#     # return lambda grid, ctx: workflow(grid, ctx | components)
